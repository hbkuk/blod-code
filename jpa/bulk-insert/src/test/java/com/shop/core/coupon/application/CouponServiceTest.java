        ...
        class 성공 {
            ...
            class 대량_쿠폰_발급 {
                ...
                void 사전_준비() {
                    ...
                    랜덤_회원_이메일_목록 = 랜덤_회원_목록.stream().map(Member::getEmail).collect(Collectors.toList());
                ...
                void 쿠폰_정상_발급() {
                    // when
                    CouponIssueRequest 발급할_쿠폰_정보 = CouponIssueRequest.of(등록된_쿠폰.getId(), 랜덤_회원_이메일_목록);
                    ...
                    assertThat(발급된_쿠폰_목록의_회원_이메일).containsAnyElementsOf(랜덤_회원_이메일_목록);
                }
